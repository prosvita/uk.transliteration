...
module.exports = ([
    ...
    [ /»/g, "\"" ],
    // 1. Словник виключень
    // 2. Прибираємо апостроф
    [ /([бвгґджзклмнпрстфхцчшщБВГҐДЖЗКЛМНПРСТФХЦЧШЩ])['’ʼ]([єїюяЄЇЮЯ])/g, "$1$2" ],
    // 3. 'в' в кінці речення
    [ /([абвгґдеєжзиіїйклмнопрстуфхцчшщьюяАБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ])в([^абвгґдеєжзиіїйклмнопрстуфхцчшщьюя])/g, "$1w$2" ],
    [ /([АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ])В([^АБВГҐДЕЄЖЗИІЇЙКЛМНОПРСТУФХЦЧШЩЬЮЯ])/g, "$1W$2" ],
    // 4. приголосні букви з 'ь'
    [ /бь/g, "ḅ" ],
    [ /вь/g, "ṿ" ],
    [ /гь/g, "ḥ" ],
    [ /ґь/g, "x" ],
